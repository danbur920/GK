...
private void drawWorld(Graphics2D g2) {
    ...
    //1 object
    drawRotatingPolygon(g2, -0.98 , 0, 1);
    drawRotatingPolygon(g2,  1, -0.52,1);
    drawRedRectangle(g2, 2.15,0.15,0.08,-0.25);
    drawTriangle(g2,0.4,0.6,0,-2.05,Color.blue);
    //2 object
    drawRotatingPolygon(g2,  -1.4, 1.52, 0.8);
    drawRotatingPolygon(g2,  -3.05, 1.95, 0.8);
    drawRedRectangle(g2,1.8,0.12, -2.6, 1.1);
    drawTriangle(g2,0.3,0.4,-2.25,0.55, new Color(120, 0, 160));
    //3 object
    drawRotatingPolygon(g2,  1.42, 2, 0.6);
    drawRotatingPolygon(g2,  2.65, 1.68, 0.6);
    drawRedRectangle(g2,1.35,0.10, 1.5, 2.3);
    drawTriangle(g2,0.2,0.3,2,0.95, new Color(0, 120, 0));
...
private void drawTriangle (Graphics2D g2, double scaleX , double scaleY, double translateX ,double translateY ,Color color )
{
...
private void drawRedRectangle(Graphics2D g2, double scaleX , double scaleY, double translateX ,double translateY)
{
    AffineTransform saveTransform = g2.getTransform();
...
private void drawRotatingPolygon(Graphics2D g2, double translate_x ,double translate_y, double scale) // polygon
{
    AffineTransform saveTransform = g2.getTransform();
    ...
    for(int i = 0; i < n; i++)
    {
        x[i] =(int) (120*Math.cos((2*Math.PI/n)*i));
        y[i] =(int) (120*Math.sin((2*Math.PI/n)*i));
    }
