...
public class SceneGraph extends JPanel {
    ...
    private TransformedObject triangle1, triangle2, triangle3;
    private TransformedObject line1, line2, line3;
    private TransformedObject polygon1, polygon2, polygon3, polygon4, polygon5, polygon6;
    ...
    private void createWorld() {
        ...
        polygon1 = new TransformedObject(wielokat);
        polygon1.setTranslation(-1,0);
        world.add(polygon1);
        polygon2 = new TransformedObject(wielokat);
        ...
        world.add(triangle1);
        //---------------------------
        polygon3 = new TransformedObject(wielokat);
        polygon3.setTranslation(-1.42,1.5).setScale(0.8,0.8);
        world.add(polygon3);
        polygon4 = new TransformedObject(wielokat);
        ...
        triangle2.setScale(0.5,1.2).setTranslation(-2.25,0.5).setColor(new Color(110, 0, 160));
        world.add(triangle2);
        //---------------------------
        polygon5 = new TransformedObject(wielokat);
        polygon5.setTranslation(1.42,2.02).setScale(0.6,0.6);
        world.add(polygon5);
        polygon6 = new TransformedObject(wielokat);
        ...
        triangle3.setScale(0.3,1).setTranslation(2,0.85).setColor(new Color(0, 120, 0));
        world.add(triangle3);
    ...
    public void updateFrame() {
        ...
        polygon1.setRotation(frameNumber*3.75);
        polygon2.setRotation(frameNumber*100000.75);
    ...
    private static SceneGraphNode wielokat = new SceneGraphNode() {
        void doDraw(Graphics2D g) {
            int n = 11;
            int[] x = new int[n];
            int[] y = new int[n];
